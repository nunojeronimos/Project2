...
class App:
    def __init__(self):
        ...
        self.db_dir = './db'  # Relative path to create 'db' directory in the current working directory
    ...
    def process_webcam(self):
        ...
        self._label_.imgtk = imgtk
        self._label_.configure(image=imgtk)

        self._label_.after(20, self.process_webcam)
